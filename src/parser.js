...
function animateS(params,obj, timeline){//对缩放进行设置动画
...
function animateF(params,obj, timeline){//变化不透明度
    let sStartTime = (params[2]<0?0:params[2])/1000;
    let sDuration = (params[3].length==0?sStartTime*1000:params[3])/1000-sStartTime;
    let startVal=Number(params[4]);
    let endVal=Number(params.length<6?params[4]:params[5]);
...
function animateMX(params,obj, timeline){//移动对象的X轴坐标
    let sStartTime = (params[2]<0?0:params[2])/1000;
    let sDuration = (params[3].length==0?sStartTime*1000:params[3])/1000-sStartTime;
...
function animateMY(params,obj, timeline){//移动对象的Y轴坐标
    let sStartTime = (params[2]<0?0:params[2])/1000;
    let sDuration = (params[3].length==0?sStartTime*1000:params[3])/1000-sStartTime;
    let startVal=params[4];
    let endVal=params.length<6?params[4]:params[5];
...
function animateM(params,obj, timeline){//移动对象的XY轴坐标
    let sStartTime = (params[2]<0?0:params[2])/1000;
    let sDuration = (params[3].length==0?sStartTime*1000:params[3])/1000-sStartTime;
...
function animateR(params,obj, timeline){//对象的旋转角度
    let sStartTime = (params[2]<0?0:params[2])/1000;
    let sDuration = (params[3].length==0?sStartTime*1000:params[3])/1000-sStartTime;
    let startVal=Number(params[4]);
    let endVal=Number(params.length<6?params[4]:params[5]);
...
function animateV(params,obj, timeline){//对象的矢量操作（压缩伸长）
    let sStartTime = (params[2]<0?0:params[2])/1000;
    let sDuration = (params[3].length==0?sStartTime*1000:params[3])/1000-sStartTime;
...
function animateC(params,obj, timeline){//对象的色调操作
    let sStartTime = (params[2]<0?0:params[2])/1000;
    let sDuration = (params[3].length==0?sStartTime*1000:params[3])/1000-sStartTime;
    //开始的RGB
...
export {
    animateMX, animateMY, animateC, animateF, animateS, animateR, animateV, animateM}
